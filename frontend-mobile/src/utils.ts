export function isValidCpf(cpf: string): boolean {
  ...
  let sumFirstDigit = 0, remainderFirstDigit = 0
  let sumSecondDigit = 0, remainderSecondDigit = 0
